...
// Completing Profile code
if (isset($_POST['prof_reg'])) {
	...
	if (mysqli_num_rows($results) == 1) {
		// Inserting data into table
		$query = "INSERT INTO patients (FirstName, LastName, TelNo, IDNo, DOB, gender)
				VALUES('$username', '$FirstName' , '$LastName' , '$TelNo' , '$IDNo' , '$DOB' , '$gender')";
		}
		
		// Welcome message
		$_SESSION['success'] = "You have successfully craeted a profile with SmartMedi";
