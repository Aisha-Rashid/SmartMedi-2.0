					...
					<div class="contact-block">
						...
						<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
									<input type="number" class="form-control" name="LastName" value="">
									</div>   
								</div> 
								<div class="col-md-6">
									<label>Email</label>
								...
								<!--div class="col-md-6">
									...
									<div class="form-group">
									<input type="number" class="form-control" name="IDNo" value="">
									</div>   
								</div-> 
								<div class="col-md-6">
								...
								<div class="col-md-6">
										...
										name="reg_user">Email me billing details</button>
										</div>
									</div>
